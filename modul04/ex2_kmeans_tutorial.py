import matplotlib.pyplot as plt  # This will be used to plot the data
import numpy as np
...
cmap_bold = [ListedColormap(['#FF0000', '#00FF00']),  # type: ignore
             ListedColormap(['#FF0000', '#00FF00', '#0000FF']),  # type: ignore
             ListedColormap(['#FF0000', '#00FF00', '#0000FF', '#FFFF00']),  # type: ignore
             ListedColormap(['#FF0000', '#00FF00', '#0000FF', '#FFFF00', '#00FFFF']),  # type: ignore
             ListedColormap(['#FF5733', '#3498DB', '#F1C40F', '#2ECC71', '#9B59B6', '#E74C3C'])]  # type: ignore
